...
_Figure 21 : Sequence diagram for the Location Command.
...
_Figure 22 : Sequence diagram for the Email Command.
...
_Figure 23 : Sequence diagram for parsing the Email Command
